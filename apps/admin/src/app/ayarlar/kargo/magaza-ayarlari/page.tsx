  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-bold text-gray-900 mt-2">Mağaza Kargo Ayarları</h1>
        <p className="text-gray-600 mt-1">Mağazaya özel kargo ücret/limit ve aktivasyon ayarları</p>
      </div>
